...
### VEGETATION
vegetation <- read_excel("All_productivity.xlsx", sheet = "Vegetación")
...
### ABOVEGROUND BIOMASS
abovegrbiomass <- read_excel("All_productivity.xlsx", sheet = "Pesos Above Ground")
...
### DEVELOPMENT
development <- read_excel("All_productivity.xlsx", sheet = "Desarrollo ESP.")
...
### BELOWGROUND BIOMASS
belowgrbiomass <- read_excel("All_productivity.xlsx", sheet = "Pesos Below Ground")
...
### CLIMATE
climate <- read_excel("All_productivity.xlsx", sheet = "Humedad-Temperatura")
...
### RESPIRATION
respiration <- read_excel("All_productivity.xlsx", sheet = "Respiracion")
...
#**********************************************************************************
### SPECIES
sp <- read_excel("Especies Puna.xlsx")

speceis <- sp %>% 
  select(Copdigo, Especie) %>% 
  rename(Code = Copdigo, Species = Especie)


### SPECIES COMPOSITION
abundance <- read_excel("Species_comp.xlsx", sheet = "Species_comp")
# fix year!!!
...
### ABOVEGROUND BIOMASS
agbiomass <- read_excel("All_matrix_2017-11-07.xlsx", sheet = "AGB_matrix")
...
### BELOWGROUND BIOMASS
bgbiomass <- read_excel("All_matrix_2017-11-07.xlsx", sheet = "BGB_matrix")
...
### RESPIRATION
respiration <- read_excel("All_matrix_2017-11-07.xlsx", sheet = "Resp_matrix")
...
### NPP
npp <- read_excel("All_matrix_2017-11-07.xlsx", sheet = "NPP_matrix")
